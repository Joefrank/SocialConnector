...
namespace Magicalia.MPS.Utilities
{
    ...
    public class FTPUploadProgressEventArgs : System.EventArgs
    {
        public long BytesUploaded { get; set; }

        public long TotalBytes { get; set; }

        public FTPUploadProgressEventArgs(long bytesUploaded, long totalBytes)
        {
    ...
    {
        public event UploadProgressDelegate UploadProgressChanged;
        ...
        public string[] GetFileList(string mask)
        {
            ...
            System.DateTime timeout = System.DateTime.Now.AddSeconds(this.timeoutSeconds);
        ...
        public void Upload(string fileName, bool resume)
        {
            ...
            while ((bytes = input.Read(buffer, 0, buffer.Length)) > 0)
            {
                ...
                {
                    this.UploadProgressChanged(this, new FTPUploadProgressEventArgs(bytesUploaded, input.Length));
                }
